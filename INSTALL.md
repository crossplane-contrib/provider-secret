# Building and Installing the Crossplane Cluster API Provider

`provider-secret` is composed of a golang project and can be built directly with
...
You can build the Crossplane Secret Provider for the host platform by
